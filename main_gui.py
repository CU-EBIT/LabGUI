...
from PyQt5.QtWidgets import QMainWindow, QMenu, QApplication, QLabel, QHBoxLayout, QPushButton, QWidget, QVBoxLayout
from PyQt5.QtWidgets import QAction # This line is all that changed from Qt5 to Qt5
